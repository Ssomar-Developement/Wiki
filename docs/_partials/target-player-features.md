...
When the second actor of the event is a player then you can use in your activator config (commands, conditions, other..) [the target player placeholders](/docs/tools-for-all-plugins-score/placeholders#-player-placeholders)
