...
When the main actor of the event is an entity then you can use in your activator config (commands, conditions, other..) [the entity placeholders](/docs/tools-for-all-plugins-score/placeholders#entity-placeholders)