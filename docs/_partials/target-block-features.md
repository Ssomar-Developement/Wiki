...
* Info: List of commands that are normally run against the block when the activator triggers.
  ...
  * You can check the list of blockCommands here -> [Target block commands](/tools-for-all-plugins-score/custom-commands/block-commands)
* Example:
...
* [Target block conditions](/tools-for-all-plugins-score/custom-conditions/block-conditions.md)


### Target Block placeholders

When the main actor of the event is a block then you can use in your activator config (commands, conditions, other..) [the target block placeholders](/tools-for-all-plugins-score/placeholders#-block-placeholders)